		...
		public void TestHierarchy4()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					.ThenChildren(Some<InfiniteBeerList>.Records)
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List)
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy5()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List)
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy6()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy7()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy8()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy9()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy10()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy11()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy12()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy13()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy14()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy15()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
		[Test]
		public void TestHierarchy16()
		{
			var result = Connection().QuerySql(
				...
				Query.Returns(Some<InfiniteBeerList>.Records)
					...
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					.ThenChildren(Some<InfiniteBeerList>.Records, parents: b => b.List.SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List).SelectMany(b2 => b2.List), into: (b, list) => b.List = list.ToList())
					);
			InfiniteBeerList.VerifyAll(result);
		}
